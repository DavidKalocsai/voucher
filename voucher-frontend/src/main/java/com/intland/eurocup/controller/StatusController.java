...
import com.intland.eurocup.service.id.RequestIdGenerator;
import com.intland.eurocup.service.response.ResponseStorage;

import lombok.extern.log4j.Log4j;

/**
 * Controller to handle status form. Status form displays information of
 * submitted voucher and response status.
 *
 */
@Log4j
@Controller
public class StatusController {
  ...
  @Autowired
  private RequestIdGenerator uniqueRequestIdGenerator;
  ...
  public ModelAndView showStatus(@PathVariable Territory territory, @ModelAttribute(MODEL_ATTRIBUTE) Voucher voucher) {
